...
def is_mel(name, email):
    ...
    >>> is_mel("Balloonicorn", "balloonicorn@gmail.com")
    False
    ...
    if "Mel" in name or "Melitpolski" in name:
...
def most_and_least_common_type(treats):
    ...
    >>> most_and_least_common_type([{'type': 'melons'}, {'type': 'melons'}, {'type': 'dessert'}, {'type': 'dessert'}, {'type': 'drink'}])
    ('melons', 'drink')

    >>> most_and_least_common_type([{'type': 'dessert'}, {'type': 'dessert'}, {'type': 'melons'}, {'type': 'melons'}, {'type': 'drink'}])
    ('dessert', 'drink')
